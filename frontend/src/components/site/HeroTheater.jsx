...
const HeroTheater = ({ onOpenInquiry }) => {
  ...
  return (
    <section
      ...
      className="relative pt-[100px] sm:pt-[120px] md:pt-[140px] pb-16 md:pb-28 overflow-hidden"
    >
      <div className="absolute inset-0 hero-radial pointer-events-none" />

      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="flex items-center justify-center gap-2 mb-8 animate-fade-in flex-wrap">
          ...
          <span className="text-[11px] sm:text-[12px] uppercase tracking-[0.12em] sm:tracking-[0.22em] text-stone-600 text-center">
            {t("hero.rating")}
          </span>
        </div>
        ...
        >
          <div className="relative rounded-[24px] sm:rounded-[28px] md:rounded-[32px] overflow-hidden bg-stone-100 aspect-[4/3] sm:aspect-[16/9] md:aspect-[21/9]">
            <img
            ...
            <div
              ...
              className="flex absolute top-3 left-3 sm:top-8 sm:left-8 flex-col gap-1 backdrop-blur-md bg-white/85 border border-stone-200 rounded-xl sm:rounded-2xl px-3 py-2 sm:px-5 sm:py-4 shadow-sm"
            >
            ...
            <div
              ...
              className="flex absolute bottom-3 right-3 sm:bottom-8 sm:right-8 flex-col gap-1 backdrop-blur-md bg-white/85 border border-stone-200 rounded-xl sm:rounded-2xl px-3 py-2 sm:px-5 sm:py-4 shadow-sm"
            >
              <span className="text-[10px] font-bold uppercase tracking-[0.22em] text-stone-500">
                {t("hero.badge_craft")}
              </span>
