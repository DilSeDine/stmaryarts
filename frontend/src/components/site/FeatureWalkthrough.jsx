...
import { ShoppingBag, Briefcase, Megaphone } from "lucide-react";
...
const PLACES = [
  {
    number: "01",
    label: "Shop Fronts",
    title: "Make your shop impossible to miss.",
    image:
      "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=1200",
    icon: ShoppingBag,
    points: [
      "LED glow signs & backlit shop boards",
      "Shop name boards & fascia signage",
  ...
  },
  {
    ...
    title: "A professional face for every brand.",
    image:
    ...
    points: [
      ...
      "Acrylic 3D letters for lobbies",
      "Corporate branding & wayfinding",
    ],
  },
  {
    number: "03",
    label: "Events & Outdoor",
    title: "Print fast, look sharp every time.",
    image:
      "https://images.pexels.com/photos/35339499/pexels-photo-35339499.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    icon: Megaphone,
    points: [
      "Flex banners & exhibition standees",
      "Vinyl stickers & branding wraps",
